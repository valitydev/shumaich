...
public class PostingDamselToPostingConverterTest {
    ...
    public void conversion() {
        ...
        assertEquals(postingDamsel.getFromAccount().getCurrencySymbolicCode(), posting.getFromAccount().getCurrencySymbolicCode());
        assertEquals(postingDamsel.getFromAccount().getId(), posting.getFromAccount().getId());
        assertEquals(postingDamsel.getToAccount().getCurrencySymbolicCode(), posting.getToAccount().getCurrencySymbolicCode());
